            ...
            <form action="${pageContext.request.contextPath}/admin/address?action=createTrademarkAddress" method="POST"
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary font-weight-bolder"
                            onclick="checkValidAddress('add-address')">Thêm
                    </button>
                </div>
            </form>
        </div>
...
<div class="modal fade" id="update-address-modal" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content card card-success">
            ...
            <form action="${pageContext.request.contextPath}/admin/address?action=update" method="POST"
                  id="update-address" novalidate="novalidate">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-danger font-weight-bolder" data-dismiss="modal">Hủy</button>
                    <button type="button" class="btn btn-primary font-weight-bolder"
                            onclick="checkValidAddress('update-address')">Cập nhật
                    </button>
                </div>
            </form>
        </div>
