                ...
                <div class="faqs">
                    <ul>
                        ...
                        <li class="item">
                            ...
                            <div class="ans hidden">
                                <p class="first">
                                    Bạn có thể thanh toán bằng nhiều cách như thanh toán trực tiếp khi nhận hàng, thanh
                                    toán qua thẻ ngân hàng, các app banking, tài khoản momo hoặc chuyển khoản.
                                </p>
                            </div>
                        </li>
                        <li class="item">
                            ...
                            <div class="ans hidden">
                                <p class="first">
                                    Nếu bạn có vấn đề liên quan đến các hình thức thanh toán khi đang trong quá trình
                                    thanh toán, hãy liên hệ với chúng tôi để nhận được sự giúp đỡ của bộ phận kĩ thuật.
                                </p>
                            </div>
                        </li>
                    </ul>
