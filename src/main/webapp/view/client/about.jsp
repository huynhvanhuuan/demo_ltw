...
<head>
    ...
    <link rel="stylesheet" href="<%=path%>/assets/css/root.css" />
    <link rel="stylesheet" href="<%=path%>/assets/css/grid.css" />
    <link rel="stylesheet" href="<%=path%>/assets/css/about-us.css" />
        ...
        <div class="row">
            <div class="col">
                <div class="d-flex justify-content-center" id="image-1">
                    <img class="w-100 h-100" src="<%=path%>/assets/images/about-us/about1.png" alt="Image 1"/>
                </div>
            </div>
            <div class="col">
                <div class="content">
        ...
        <div class="row">
            <div class="col">
                <div class="d-flex justify-content-end" id="image-2">
                    <img src="<%=path%>/assets/images/about-us/about2.png" alt="Image 2" />
                </div>
            </div>
            <div class="col">
                <div class="d-flex justify-content-start" id="image-3">
                    <img src="<%=path%>/assets/images/about-us/about3.png" alt="Image 3" />
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="d-flex justify-content-between">
                    <img src="<%=path%>/assets/images/about-us/about4.png" alt="Image 4" />
                    <img src="<%=path%>/assets/images/about-us/about6.png" alt="Image 6" />
                    <img src="<%=path%>/assets/images/about-us/about5.png" alt="Image 5" />
                    <img src="<%=path%>/assets/images/about-us/about8.png" alt="Image 8" />
                    <img src="<%=path%>/assets/images/about-us/about7.png" alt="Image 7" />
                    <img src="<%=path%>/assets/images/about-us/about9.png" alt="Image 9" />
                </div>
            </div>
        </div>
    </div>
