            ...
            <div class="slide">
                <div class="cards">
                    ...
                    <div class="card">
                        ...
                        <div class="card-img">
                            <img class="card-img-item" src="<%=path%>/assets/images/giuong-ngu-go-vline601/giuong-ngu-go-vline-1.png" alt="card image"/>
                        </div>
                        <div class="card-content">
                            <div class="card-title">
                    ...
                    <div class="card">
                        ...
                        <div class="card-discount">20% giảm</div>
                        <div class="card-img">
                            <img class="card-img-item" src="<%=path%>/assets/images/ban-tra-tron-cao-go/ban-sofa-ban-cafe-ban-tra-tron-cao-go.png" alt="card image"/>
                        </div>
                        <div class="card-content">
                            <div class="card-title">
                    ...
                    <div class="card">
                        ...
                        <div class="card-img">
                            <img class="card-img-item" src="<%=path%>/assets/images/tu-ke-tivi-go/tu_ke_tu_tivi_go_1.jpg" alt="card image"/>
                        </div>
                        <div class="card-content">
                            <div class="card-title">
