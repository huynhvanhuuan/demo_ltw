        ...
        <div class="signin">
            ...
            <div class="right">
                <div class="popup-header">
                    <img src="${pageContext.request.contextPath}/assets/images/logo.jpg" alt="popup logo"
                ...
                <div class="other-way-signin">
                    <a href="?fb" class="btn-signin signin-fb">
                        <img src="${pageContext.request.contextPath}/assets/images/fb.png" alt="facebook sign in"
                             class="signin-img"/>
                        <span class="signin-title">Facebook</span>
                    </a>
                    <a href="?gg" class="btn-signin signin-gg">
                        <img src="${pageContext.request.contextPath}/assets/images/gg.png" alt="facebook sign in"
